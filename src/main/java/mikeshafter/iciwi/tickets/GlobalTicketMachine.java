...
//
//    tm.setItem(1, makeItem(Material.PAPER, lang.getComponent("menu-new-ticket"), Component.text(plugin.getConfig().getDouble("global-ticket-price"))));
//    tm.setItem(4, makeItem(Material.NAME_TAG, lang.getComponent("card-operations")));
//    tm.setItem(7, makeItem(Material.BOOK, lang.getComponent("check-fares")));
//
