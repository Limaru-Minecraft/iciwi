...
@Command("iciwi owners operator <station> list")
@CommandDescription("Lists the owning companies of a station.")
...
@Command("iciwi railpass list")
@CommandDescription("Lists all railpasses")
@Permission("iciwi.owners.railpass")
public void owners_railpass_list(
	final @NonNull CommandSender sender,
	final Iciwi plugin
) {
